...
CREATE TABLE `academic_periods` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_academic_periods_active` (`is_active`)
...
INSERT INTO `academic_periods` VALUES (2,'2025-2026','1st Semester',0,'2026-05-10','2026-11-10'),(3,'2026-2027','1st Semester',1,'2026-05-10','2026-11-10');
