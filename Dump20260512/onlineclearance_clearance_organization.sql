...
CREATE TABLE `clearance_organization` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_co` (`student_number`,`position`),
...
INSERT INTO `clearance_organization` VALUES (1,'724','Cashier','Pending'),(2,'724','Organization Adviser','Cleared'),(3,'724','Organization Treasurer','Cleared'),(4,'724','Registrar','Cleared'),(5,'724','sdggdvdsfg','Pending');
